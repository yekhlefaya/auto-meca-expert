...
1. Clonez ce dépôt :
   ```bash
   git clone https://github.com/votre-nom-utilisateur/auto_meca_expert.git
   cd auto_meca_expert
   ```
...
L'interface web s'ouvrira dans votre navigateur. Vous pouvez alors poser des questions sur les véhicules hybrides, et l'agent sélectionnera automatiquement le modèle approprié pour répondre.

### Exemples de requêtes
- "Diagnostic d'une panne moteur sur Toyota Prius"
- "Code erreur P0A12 sur Honda Hybrid"
- "Procédure de remplacement batterie hybride"
